...
public class SpanMetricsResult extends QueryResult{
    private TreeSet<InterfaceMetrics> data =new TreeSet<>();

    public TreeSet<InterfaceMetrics> getData() {
        return data;
    }

    public void setData(TreeSet<InterfaceMetrics> data) {
        this.data = data;
    }

    public static class InterfaceMetrics implements Comparable<InterfaceMetrics>{
        ...
        public static Builder newBuilder(InterfaceMetrics copy) {
        ...
        @Override
        public int compareTo(InterfaceMetrics o) {
