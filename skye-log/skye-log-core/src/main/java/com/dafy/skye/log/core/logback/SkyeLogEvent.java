 ...
 */
public class SkyeLogEvent implements ILoggingEvent,Serializable{
    ...
    public static SkyeLogEvent build(ILoggingEvent le){
        SkyeLogEvent ledo = new SkyeLogEvent();
    ...
    public boolean equals(Object obj) {
        if(this == obj) {
            ...
            SkyeLogEvent other = (SkyeLogEvent) obj;
